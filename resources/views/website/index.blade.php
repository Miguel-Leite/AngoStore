								...
								<div class="products-slick" data-nav="#slick-nav-1">
									...
									<div class="product">
										...
										<div class="product-body">
											...
											<h3 class="product-name"><a href="{{ route('website.product') }}">product name goes here</a></h3>
									...
									<div class="product">
										<div class="product-img">
											<img src="{{ asset('website/img/product04.png') }}" alt="">
										</div>
										<div class="product-body">
											<p class="product-category">Categoria</p>
											<h3 class="product-name"><a href="{{ route('website.product') }}">product name goes here</a></h3>
									...
									<div class="product">
										<div class="product-img">
											<img src="{{ asset('website/img/product05.png') }}" alt="">
										</div>
										<div class="product-body">
											<p class="product-category">Categoria</p>
											<h3 class="product-name"><a href="{{ route('website.product') }}">product name goes here</a></h3>
						...
						<div class="products-tabs">
							...
							<div id="tab2" class="tab-pane fade in active">
								<div class="products-slick" data-nav="#slick-nav-2">
									...
									<div class="product">
										<div class="product-img">
											<img src="{{ asset('website/img/product07.png') }}" alt="">
											<div class="product-label">
												<span class="new">NOVO</span>
											</div>
										</div>
									...
									<div class="product">
										<div class="product-img">
											<img src="{{ asset('website/img/product09.png') }}" alt="">
										</div>
										<div class="product-body">
											<p class="product-category">Categoria</p>
											<h3 class="product-name"><a href="{{ route('website.product') }}">product name goes here</a></h3>
