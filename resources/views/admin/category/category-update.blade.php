...
@section('content')
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item active"><a href="{{ route('admin.category-update',$category->id) }}">atualizar</a></div>
        </div>
    </div>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-6 col-sm-8 col-xs-12">
                <div class="card card-info">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('admin.category-update',$category->id) }}" class="needs-validation form-category-update" novalidate="">
                            @csrf
